...
public class TestTrip {
  ...
  public void testUserDefined() {
      testOpt =  new Option("user defined", "yards", 3959.0);
      place = new ArrayList<>();
      place.add(new Place("P01", "one", 41.000155556, -109.05));
      place.add(new Place("P02", "two", 41.00055556, -102.05166667));
      place.add(new Place("P03", "three", 18, -104));
      place.add(new Place("P04", "four", 39, 116));
      testTrip = new Trip(testOpt, place);
      ...
      for(int i = 0; i< expectedDistances.size(); i++) {
          assertEquals(expectedDistances.get(i), testTrip.distances.get(i), 1);
      }
  }
}
