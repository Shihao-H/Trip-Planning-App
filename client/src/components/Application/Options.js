...
import {Card, CardBody, FormGroup, ButtonGroup, Input, Collapse, Button} from 'reactstrap'
    ...
    render() {
        ...
        return(
            <div className={'text-center'}>
                <Card>
                    <CardBody><p>Select the units you wish to use.</p>
                        <Button onClick={this.dropdown} className = 'btn-outline-dark' size='lg'>Choose Units</Button>
                            <Collapse isOpen = {this.state.collapse}>
                                <ButtonGroup size="lg" vertical> {buttons} </ButtonGroup> <p>{' '}</p>
