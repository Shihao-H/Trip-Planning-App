...
### Punctuality
Members are expected to be punctual. First, all team members are expected to accomplish their tasks before the deadlines which are decided by the team, maybe different from the deadlines required by Dave. If a team member have an emergency and cannot complete the tasks assigned to him/her, he/she must inform the other team members as soon as possible, so that the others can deal with that condition and won't miss the deadlines. Second, all team members should attend the weekly team meetings on time. 
